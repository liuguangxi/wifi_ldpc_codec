...
// sh[7] = 1 iff Z = 54 and sh[6:0] >= 27 else 0
// sh[8] = 1 iff Z = 54 else 0
assign mux_d6_1 = (sh[7]) ? d6[80:54] : d6[53:27];
assign mux_d6_2 = (sh[8]) ? d6[26:0] : d6[80:54];
assign d_out = {mux_d6_2, mux_d6_1, d6[26:0]};
