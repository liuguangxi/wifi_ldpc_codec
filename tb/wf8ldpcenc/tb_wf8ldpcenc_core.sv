//==============================================================================
// tb_wf8ldpcenc_core.sv
//
// Testbench for module wf8ldpcenc_core.
//------------------------------------------------------------------------------
...
module tb_wf8ldpcenc_core;

//------------------------------------------------------------------------------
// Parameters
parameter real ClkPeriod = 10.0;
parameter real Dly = 1.0;
parameter string TcDir = "../../case/wf8ldpcenc";
...
task automatic parse_tc;
    const int VecNb[4] = '{24, 48, 72, 144};
    string fn_tc;
    string str_line;
    int code;
    int idx;
