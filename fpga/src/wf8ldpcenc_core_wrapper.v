//==============================================================================
// wf8ldpcenc_core_wrapper.v
//
// Wrapper of module wf8ldpcenc_core.
//------------------------------------------------------------------------------
...
module wf8ldpcenc_core_wrapper (
    // System signals
...
// Assignments
assign {rst_n, srst, vld_in, sop_in, mode_in, data_in} = word_o;
assign word_i = {rdy_in, vld_out, sop_out, eop_out, data_out};
...
wf8ldpcenc_core u_wf8ldpcenc_core (
    .clk            (clk),
    .rst_n          (rst_n),
    .srst           (srst),
    .vld_in         (vld_in),
